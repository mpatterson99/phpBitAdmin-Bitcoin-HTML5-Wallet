...
<div data-role="page" id="home" data-theme="a">
	...
	<div data-role="content" class="content">
		...
		<div class="div_WalletOverview">
			...
			<span class="secondary_lite"><?php print $check_login['balance']; ?>&nbsp;BTC</span>
		</div>
		
		<div class="div_WalletOverview">
			<span class="primary">Fee per transaction:</span>
			<span class="secondary_lite"><?php print (string)$check_login['paytxfee']; ?></span>
		</div>
		
		<div class="div_WalletOverview">
			<span class="primary">Wallet Version:</span>
			<span class="secondary_lite"><?php print (string)$check_login['walletversion']; ?></span>
		</div>
		
		<div class="div_WalletOverview">
			<span class="primary">Network:</span>
			<span class="secondary_lite"><?php if ($check_login['testnet']) { print 'Testnet'; } else { print 'Main'; }?></span>
		</div>	
	
		<div class="div_WalletOverview">
			<span class="primary">Bitcoind Protocol:</span>
			<span class="secondary_lite"><?php print $check_login['protocolversion']; ?></span>
		</div>
	
		<div class="div_WalletOverview">
			<span class="primary">Current Connections:</span>
			<span class="secondary_lite"><?php print $check_login['connections']; ?></span>
		</div>
	</div><!-- /content  -->
